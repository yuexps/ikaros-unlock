...
ctypes.windll.kernel32.SetConsoleTitleW("Minecraft恢复[win10]")
...
def SystemWOW64():
    try:
        ...
        print("删除过验证文件SystemWOW64 DLL...")
        os.remove('C:\\Windows\\SystemWOW64\\Windows.ApplicationModel.Store.dll')
        print("SystemWOW64 DLL 删除成功！")

        print("恢复SystemWOW64 DLL备份...")
        old_path_32 = 'C:\\Windows\\SystemWOW64\\Windows.ApplicationModel.Store.dll'
        new_path_32 = 'C:\\Windows\\SystemWOW64\\Windows.ApplicationModel.Store.dll.backup'
        os.rename(new_path_32,old_path_32)
        time.sleep(1)
        print(">伊卡洛斯：SystemWOW64 DLL 恢复完成！<")
