...
ctypes.windll.kernel32.SetConsoleTitleW("Minecraft过验证[win11]")
...
def welcome():
    ...
    print("仅支持Windows11，仅支持Windows11 ！！！")
...
def system32():
    try:
        ...
        src_path_32 = resource_path("resouces/win11/System32/Windows.ApplicationModel.Store.dll")
...
def SysWOW64():
    try:
        ...
        print("SysWOW64 DLL 备份成功！")

        print("替换新SysWOW64 DLL...")
        src_path_64 = resource_path("resouces/win11/SysWOW64/Windows.ApplicationModel.Store.dll")
        dst_path_64 = 'C:\\Windows\\SysWOW64'
        shutil.copy(src_path_64, dst_path_64)
        time.sleep(1)
        print(">伊卡洛斯：SysWOW64 DLL 处理完成！<")
